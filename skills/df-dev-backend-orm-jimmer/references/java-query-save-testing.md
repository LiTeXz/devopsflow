# Java Query Save Testing

- 优先使用 Java DSL 和生成的 table class 表达 predicate、join、ordering、pagination 和 projection，不要拼接 SQL 字符串。
...
- 修改实体或 DTO 后运行 compile/APT 任务和针对性的 Java/JVM persistence test，确认生成代码已刷新。
