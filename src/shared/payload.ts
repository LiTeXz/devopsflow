...
import type { Payload, ToolInput } from "./types"
...
export const SHELL_TOOL_NAMES = new Set(["Bash", "shell", "exec", "exec_command", "unified_exec"])
...
export function findAgentName(payload: Payload): string {
  ...
  return values.filter((v): v is string => typeof v === "string").join(" ").trim()
}
