...
describe('ProtectedBranchPushHook', () => {
  ...
  describe('nested repository branch detection', () => {
    ...
    it('uses git -C cwd for git writes in nested repositories', () => {
      ...
      expect(shouldBlock(`git -C "${nestedDir}" add README.md`, nestedRoot)).toBeUndefined()

      switchBranch(nestedDir, 'dev')
      const decision = shouldBlock(`git -C "${nestedDir}" add README.md`, nestedRoot)
      expect(decision).not.toBeNull()
      expect(decision?.branch).toBe('dev')
  ...
  describe('shell commands on protected branch', () => {
    ...
    it('blocks file mutation commands on protected branch', () => {
      ...
      expect(shouldBlock('rg -n DevopsFlow README.md;rm README.md', mainRepo)).not.toBeNull()
    })
  ...
  describe('safe operations', () => {
    ...
    it('allows read-only commands on protected branch', () => {
      ...
      expect(shouldBlock('rg -n DevopsFlow README.md', mainRepo)).toBeUndefined()
